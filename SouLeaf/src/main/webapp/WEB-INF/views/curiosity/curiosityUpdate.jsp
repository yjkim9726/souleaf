							...
							<div class="row no-gutters">
								...
								<div class="col-md-12">
									<div class="contact-wrap w-100 p-md-5 p-4">
										...
										<form action="curiosityModify.kh" method="post" enctype="multipart/form-data">
											<div class="row">
										
												<div class="col-md-12">
													<div class="form-group">
														<label class="label" for="subject">제목</label>
														<input type="text" class="form-control" name="curiosityContent" id="curiosityContent" value="${curiosity.curiosityContent }">
													</div>
												</div>
												...
												<div class="col-md-12">
													<div class="form-group">
														...
														<textarea name="curiosityContents" class="form-control" id="summernote" cols="30" rows="1" placeholder="이 식물 이름이 뭔가요?">${curiosity.curiosityContents }</textarea>
													</div>
												</div>
												<div class="col-md-12">
													<div class="form-group">
